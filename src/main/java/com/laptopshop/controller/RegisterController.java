...
public class RegisterController {
    ...
    public String registerProcess(@ModelAttribute("newUser") @Valid NguoiDung nguoiDung, BindingResult bindingResult,
        ...
        try {
            // sendMail(nguoiDung.getEmail(), nguoiDung.getEmail(),
            // nguoiDung.getPassword());
            emailUlti.sendEmail(nguoiDung.getEmail(), "Register success !!!",
    ...
    // final String fromEmail = "sikienbmto1@gmail.com";
    // final String password = "01263500";
    // final String toEmail = email;
    // final String subject = "Register success !!!";
    // final String body = "You have successfully registered an account with
    // username: " + username + " ";
